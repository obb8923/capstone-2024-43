    ...
    const handleClick =()=>{
        switch(nav){
            ...
            case 'announcement':
                ...
                break;
            case 'contactUs':
                window.location.href = 'https://github.com/kookmin-sw/capstone-2024-43';
                break;
            case 'signOut':
                signOutSequence();
                break;
